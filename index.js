...
app.use(cors());  // https://developer.mozilla.org/en-US/docs/Web/HTTP/CORSn

mongoose.connect("mongodb+srv://wuwei123:" + process.env.MONGODB_PWD+ "@cluster0.ya6dxk1.mongodb.net/myFirstDb?retryWrites=true&w=majority",
...
// Configuring body parser middlewaren
...
//strong password--hashedPassword
